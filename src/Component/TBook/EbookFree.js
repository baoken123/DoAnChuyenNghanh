...
export default class EbookFree extends Component {
        ...
        <div className="row">
          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                <h3 className="card-title">
                  <img src="./image/Buffett-dau-tu-nhu-mot-co-gai-min.png" alt="" />
                </h3>
          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                <h3 className="card-title">
                  <img src="./image/Cong-thuc-ky-dieu-chinh-phuc-thi-truong-chung-khoan-min.png" alt="" />
                </h3>
          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                <h3 className="card-title">
                  <img src="./image/Cuoc-choi-dau-tu-mao-hiem-min.png" alt="" />
                </h3>
          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                <h3 className="card-title">
                  <img src="./image/Cuoc-noi-day-o-pho-Wall-min.png" alt="" />
                </h3>
          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                <h3 className="card-title">
                  <img src="./image/Danh-bai-pho-wall-min.png" alt="" />
                </h3>
          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                <h3 className="card-title">
                  <img src="./image/Dau-tu-mao-hiem-min.png" alt="" />
                </h3>
          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                <h3 className="card-title">
                  <img src="./image/Giao-dich-lon-min.png" alt="" />
                </h3>
          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                <h3 className="card-title">
                  <img src="./image/Luat-cua-warren-buffett-min.png" alt="" />
                </h3>
          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                <h3 className="card-title">
                  <img src="./image/Nhung-ong-trum-tai-chinh-min.png" alt="" />
                </h3>
          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                <h3 className="card-title">
                  <img src="./image/Phuong-phap-dau-tu-Warren-Buffett-min.png" alt="" />
                </h3>
  ...
  <ul className="pagination">
    ...
    <li className="page-item active">
      <a className="page-link" href="./sanpham.html">1</a>
    </li>
    <li className="page-item"><a className="page-link" href="./sanpham1.html">2</a></li>
