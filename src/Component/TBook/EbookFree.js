          ...
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/13CNCWeF2R8SuvU7wuRLt0jfBPkOSahaF/view" className="card-text"  target="blank"><p className="card-text">BỊ QUYẾT TAY TRẮNG THÀNH TRIỆU PHÚ</p></a>
              </div>
            </div>
          </div>
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/1Sr6vqoNvDrwDcFh9ie8zwmB20AqdoN_p/view" className="card-text"  target="blank"><p className="card-text">ĐẦU TƯ NHƯ MỘT CÔ GÁI</p></a>
              </div>
            </div>
          </div>
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/1nam6afuNTDqEDuGrdh_a4jtGtb0Wb1_f/view" className="card-text"  target="blank"><p className="card-text">CÔNG THỨC KỲ DIỆU CHINH PHỤC THỊ TRƯỜNG CHÚNG KHOÁN</p></a>                         
              </div>
            </div>
          </div>
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/1O-rKEoxpsn49PAQdXDY1PyrkzcE0lHdU/view" className="card-text"  target="blank"><p className="card-text">CUỘC CHƠI ĐẦU TƯ MẠO HIỂM</p></a>
              </div>
            </div>
          </div>
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/1RE2DgZjJu7kJov0xbb181-ksnxdIWG6I/view" className="card-text"  target="blank"><p className="card-text">CUỘC NỖI DẬY Ở PHỐ WALL</p></a>                             
              </div>
            </div>
          </div>
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/1uAqpuINuvVcqTr7cqH-Axlu4QfHhMcKC/view" className="card-text"  target="blank"><p className="card-text">ĐÁNH BẠI PHỐ WALL</p></a>
              </div>
            </div>
          </div>
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/1SpqJSnF53-qSkXZHbuUdkEIRKDfjO9Jm/view" className="card-text"  target="blank"><p className="card-text">ĐẦU TƯ MẠO HIỂM</p></a>
              </div>
            </div>
          </div>
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/1PKTKfsl_ZJvQIvAlNJeA7dgZVjXR7W44/view" className="card-text"  target="blank"><p className="card-text">GIAO DỊCH LỚN</p></a>
              </div>
            </div>
          </div>
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/1lN02C1NuCgy-KnCqCgLVW_9wo1KfV59y/view" className="card-text"  target="blank"><p className="card-text">LUẬT CỦA BUFFETT</p></a>
              </div>
            </div>
          </div>
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/1OYPqvW7_q8T9Xb3UGn7ebnzXvDD3d9mM/view" className="card-text"  target="blank"><p className="card-text">NHỮNG ÔNG TRÙM TÀI CHÍNH</p></a>
              </div>
            </div>
          </div>
          <div className="col-xs-1-12 col-3">
            <div className="cards">
              <div className="card-body">
                ...
                <a href="https://drive.google.com/file/d/1ygIJ-4-F46FtSyoHPXIAcx97a7bVZuNd/view" className="card-text"  target="blank"><p className="card-text">PHƯƠNG PHÁP ĐẦU TƯ WARREN BUFETT</p></a>
              </div>
            </div>
          </div>
          <Router>
